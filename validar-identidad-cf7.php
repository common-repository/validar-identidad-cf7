...
if (file_exists(WP_PLUGIN_DIR . '/contact-form-7/wp-contact-form-7.php')) {
    ...
    function custom_identidad_form_tag_handler($tag) {
        ...
        $html = sprintf(
            '<span class="wpcf7-form-control-wrap %1$s" data-name="%1$s"><input name="__identificacion" type="hidden" value="' . implode(',', $allowed_types) . '"><input type="text" %2$s />%3$s</span>',
